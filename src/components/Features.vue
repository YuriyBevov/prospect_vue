<template>
    <section class="features" id="outdoor">
        <div class="container-fluid">
            <div class="section-title section-title--dublicated">
                <h2>Наружная реклама
                    <!--<span aria-hidden="true" style="opacity: 0.8358; transform: translate(0%, -50%) translate3d(-67.1692vw, 0px, 0px);">Наружная реклама</span>-->
                </h2>
            </div>

            <div class="features__accordeon accordeon">
                <div class="accordeon__field" v-for="(item, index) in accordeonFields" :key="index">
...
<script>
    ...
    export default {
                ...
                accordeonFields: [
                    ...
                    },
                    {
                        ...
                        body: {
                            ...
                            img: 'accordeon-item-4'
                        }
                    },
                    {
                        title: 'Прямоугольный короб',
                        contentTitle: 'Прямоугольный короб',
                    ...
                    },
                    {
                        ...
                        contentTitle: 'Металлические буквы',
        ...
        methods: {
            fillImages(img) {
                return require(`@/assets/images/${img}@1x.jpg`);
            },
